...
//
//  Created by MacBookPro on 15/7/22.
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _stateLabel.textColor = [LIAppUtils colorFromRGB:0x9a9a9a];
        ...
        _dateLabel.textColor = [LIAppUtils colorFromRGB:0x9a9a9a];
        _stateLabel.shadowColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:1.0];
		_stateLabel.shadowOffset = CGSizeMake(0.0f, 1.0f);
        ...
        _arrowView.image = [UIImage imageNamed:@"common_blueArrow"];
